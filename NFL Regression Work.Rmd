...
densitypPlot(mod_wpd$fitted.values)
...
filter(games, season == 2023)


get_pagerank <- function(season_wanted, week_wanted, game_dataset){
  ...
  for (i in 1:nrow(prior_games)) {
    ...
    return(page_rank(graph_from_adjacency_matrix(teams_matrix), algo = c("prpack")))
}

get_pagerank(2023,5,games)
```
